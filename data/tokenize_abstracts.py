...
parser = argparse.ArgumentParser("Starting Tokenization")
...
if __name__ == "__main__":
    ...
    dic = {
        "PubMed_Abstracts":"/gpfs/users/langloishe/ai_studio/datasource/PubMed_Abstracts_raw",
    }
    for name, path in dic.items():
        dist_executor = SlurmPipelineExecutor(
            job_name=f"tokn-{name}",
            pipeline=[
                ParquetReader(
